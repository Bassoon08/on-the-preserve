		...
		for line in file:
			...
			if "::" in line:
				...
				if type == "object":
					...
					self.obj[start_node].append(object.object_name)
		...
		while True:
			...
			if "drop" in command:
				if object.object_name in command and object in self.objects["backpack"]:
					...
					self.obj[self.current].append(object.object_name)
			...
			if "backpack" in command:
				...
				if self.objects["backpack"] == []:
					print "Your backpack is empty!"
                        ...
                        if "cheat" in command:
                                for i, j in self.obj.iteritems():
                                        print i, j

                        if "help" in command:
                                print """
        Type 'pickup' + object name to pick up an object.
        Type 'drop' + object name to drop an object.
        The name of the object will be in single quotations like 'this'.
        All commands are in single quotations.
        Type 'backpack' to view your backpack.
        While in the backpack, type the name of the object for the description.
        Do not forget your goal is to find the missing viola.
        The viola is in one of the exhibits.
        Type 'restart' to go back to the entrance and empty your backpack.
         """
